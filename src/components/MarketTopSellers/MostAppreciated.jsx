...
import basmah from '../../assets/basma_portrait.png';
  ...
  return (
   ...
   <h3 className="text-sm font-montserrat-regular text-yankees-blue text-center mb-2 mt-1">
    ...
    <img 
      ...
      <span className="mr-12 xs:mr-4">No. of Likes: 790,000</span>
      <span >Most Liked Artwork: Sidana</span>
      </div>
...
export default mostAppreciated;