...
// Destructure properties directly from bidderDetails (which is spread as props in BiddersProfileComponent)
const BidderProfileMainContent = ({
  overview,
  goals,
  bidRequirements,
  selectionCriteria,
  ...
  // Add a check to ensure essential data exists before rendering main content
  if (!overview && (!goals || goals.length === 0) && (!bidRequirements || bidRequirements.length === 0)) {
    return <div className="text-center text-gray-500 py-4">No detailed information available for this bid.</div>;
  }
    ...
    <div className="container mx-auto ml-4">
      <div>
        ...
        <div className="mb-8 mt-4">
          <span className="text-lg font-montserrat-regular text-yankees-blue mb-4">Overview</span>
          <p className="text-yankees-blue leading-relaxed font-montserrat-light text-justify mr-4">
            {overview} {/* Access 'overview' directly */}
          </p>
        </div>
        ...
        {/* Bid Requirements */}
        {bidRequirements && bidRequirements.length > 0 && (
          <div className="mb-8">
            <h2 className="text-lg font-montserrat-regular text-yankees-blue mb-4">Bid Requirements</h2>
            <ol className="list-decimal pl-6 text-yankees-blue font-montserrat-light space-y-2 text-justify mr-4">
              {bidRequirements.map((requirement, index) => (
        ...
        {/* Prizes and Compensation Section */}
        {prizesAndCompensation && prizesAndCompensation.length > 0 && (
          <div className="mb-8">
            <h2 className="text-lg font-montserrat-regular text-yankees-blue mb-4">Prizes and Compensation</h2>
            <ul className="text-yankees-blue space-y-2 text-justify mr-4">
              {prizesAndCompensation.map((prize, index) => (
...
export default BidderProfileMainContent;
