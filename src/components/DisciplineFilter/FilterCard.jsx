...
//   return (
//     <div className="font-montserrat-light relative flex flex-col items-center lg:p-6 lg:mt-32 sm:mt-36">
//     {/* Filter Buttons */}
...
import FilterComponent from './Filter'; // Make sure this import path is correct

const FilteredCards = ({ selectedDiscipline, onDisciplineSelect }) => { // Removed 'disciplines' prop
  return (
    <div className="font-montserrat-light relative flex flex-col items-center lg:p-6 lg:mt-36 sm:mt-36">
      {/* Filter Buttons */}
      <div className="flex flex-wrap justify-center ">
        <FilterComponent
          // Removed: availableCategories={disciplines}
          selectedFilter={selectedDiscipline}
          onFilterSelect={onDisciplineSelect}
          className="text-xs md:text-sm p-1 md:p-2 rounded"
        />
      </div>
    </div>
